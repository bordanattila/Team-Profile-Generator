...
const { create } = require("./src/script");
...
function enterEngineer () {
    ...
    .then((engineerInfo) => {
        if (!engineerInfo.engineerName.trim().length) {
            throw new Error("Name was not provided.");            
        }
        if (!engineerInfo.engineerID.trim().length) {
            throw new Error("ID was not provided.");  
        }
        if (!engineerInfo.engineerEmail.trim().length) {
            throw new Error("Email was not provided.");            
        }
        if (!engineerInfo.engineerGithub.trim().length) {
            throw new Error("GitHub username was not provided.");            
        }
...
function enterIntern () {
    ...
    .then((internInfo) => {
        if (!internInfo.internName.trim().length) {
            throw new Error("Name was not provided.");            
        }
        if (!internInfo.internID.trim().length) {
            throw new Error("ID was not provided.");  
        }
        if (!internInfo.internEmail.trim().length) {
            throw new Error("Email was not provided.");            
        }
        if (!internInfo.internSchool.trim().length) {
            throw new Error("School was not provided.");            
        }
